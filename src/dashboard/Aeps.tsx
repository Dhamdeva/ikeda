import { Compontent, Footer, Frequently, Navbar } from "./Component";
        ...
        <div className="container-fluid main">
            ...
            <div className="row m-3">
                <div className="col-md-7">
                    ...
                    <p><strong>Aadhaar enabled Payment System</strong> (Aeps) is a safe, secure payment method provided by the <strong>NPCI</strong> that allows customers to withdraw cash and avail other basic banking benefits such as balance enquiry.</p>
                    <ul>
                        <li>AePS is a bank led model which allows online interoperable financial inclusion transaction at PoS (MicroATM) through the Business correspondent of any bank using the Aadhaar authentication.AePS allows you to do six types of transactions.</li>
                        <li>The only inputs required for a customer to do a transaction under this scenario are:-</li>
                        <ol>
                            <li>Bank Name</li>
            ...
            <div className="row justify-content-around my-5">
                ...
                <div className="col-md-5">
                    ...
                    <p>eKYC<br />
                    Best Finger detection<br />
                    Tokenization<br />
                    Aadhaar Seeding Status</p>
                </div>
            </div>
            ...
            />
            <Frequently
            button={"What is the maximum amount that can be withdrawn through AEPS?"}
            cardbody={"₹ 10,000 can be withdrawn through AEPS."}
            />
            <Frequently
            button={"Who can avail Aeps?"}
            cardbody={"All Indians who have Aadhar card and are Aadhar number linked with bank account."}
            />
            <Frequently
