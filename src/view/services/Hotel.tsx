...
export function Hotel() {
  return (
    <div className="container-fluid main">
      <Navbar />
      <Customer
        className={"col-md-12 hotel text-center"}
        h1={"Hotel Ticket"}
        p={"Service > Hotel Ticket"}
      />
      ...
      <div className="row m-4">
        <div className="col-md-8 ">
          <p>
            ...
            deals on air tickets. Book Hotels for all destinations across India
            ...
            tours. Enjoy great saving on Hotels, hotels, and holiday trip with
            PayPe.com.
          </p>
          <p>
            Cheap Hotels are available at PayPe.com, one of the leading travel
            portals of India. The company offers great discounts on domestic and
            international Hotel tickets. Being a reliable name in travel
            industry of India, we focus on providing smooth Hotel booking
            ...
            airline tickets and boarding pass tickets, Hotel status, arrival
            and departure times of the Hotels, web check-in and various
          ...
          <p>
            ...
            you with best possible offers. To reduce your Hotel booking cost,
            we have tied up with several banking partners. You can avail the
            best Hotel ticket booking deals for all major low-cost carriers of
          ...
          <Customer
            ...
            p={
              "As per previous findings, the best day to book cheapest Hotel tickets was Tuesday, but it’s not anymore. As a greater number of business travellers has started booking their Hotels during the week, the best day to buy those tickets is now Sunday. To avail more savings on Hotel tickets, try to book on a Sunday that is more than 21 days ahead of your trip."
            }
          />
          <Customer
            className={"col-md-12"}
            h4={"Is it cheaper to book Hotels last minute?"}
            p={
              "There is a popular belief that if you book Hotels in advance, your air tickets will be cheaper. However, contrary to the popular belief, booking airline tickets late is often cheaper. As per the research, Hotel tickets are generally cheaper if booked three weeks before departure than tickets booked 6 months ahead. But this is not necessary. The price of Hotels fluctuates daily or even hourly in various cases. Many times, it changes due to the increasing demand of a particular route by the passengers. So, sometimes Hotels get cheaper while traveling closer to the travel date and in some cases, it gets expensive."
            }
          />
        </div>
