          ...
          <ul className="navbar-nav">
            ...
            <li className="nav-item dropdown">
              ...
              <ul className="dropdown-menu">
                ...
                <li>
                  <a className="dropdown-item" href="/micro">
                    Micro ATM(mATM)
                  </a>
                </li>
                <li>
                ...
                <li>
                  <a className="dropdown-item disabled" href="/utility">
                    UTILITY SERVICES{" "}
                  </a>
                </li>
                <li>
                ...
                <li>
                  <a className="dropdown-item" href="/utility">
                    Utility Bill Payment
                  </a>
                </li>
                <li>
                  <a className="dropdown-item disabled" href="/tour">
                    TOUR & TRAVELS
                  </a>
                </li>
                <li>
                ...
                <li>
                  <a className="dropdown-item disabled" href="/special">
                    SPECIAL SERVICES
                  </a>
                </li>
                <li>
                ...
                <li>
                  <a className="dropdown-item" href="/creditpay">
                    Ceadit Pay
                  </a>
                </li>
                <li>
                  <a className="dropdown-item" href="/mutual">
                    Mutual Fund
                  </a>
                </li>
              </ul>
...
export function Headslide(props: any) {
  return (
    <div className="d-flex flex-wrap head-slide col-lg-11 col-xl-10 mx-auto p-2 ">
      <div className="col-md-6 col-12 head-slide-content d-flex flex-column justify-content-center">
        <h6>{props.h6}</h6>
        <h1>{props.h1}</h1>
        <h4>{props.h4} </h4>
        <p>{props.p} </p>
        ...
        <div className="d-flex">
          <p className="head-slide-a">
            <a href="/">
              {props.a}
            </a>
          </p>
          <p className="head-slide-a mx-4">
            <a href="/">
              {props.a1}
            </a>
          </p>
      ...
      <div className="col-md-6  col-12 mx-0 d-flex align-items-center justify-content-center">
  ...
  return (
    <div className="row mx-0 finance px-0 mx-0">
      ...
      <div className={props.className1}>
        ...
        <h3 className="fw-bold ">{props.h2}</h3>
        <ul className="px-3">
          <li>{props.li}</li>
          <li>{props.li1}</li>
        </ul>
...
export function Playstore(props: any) {
  return (
    <div className="d-flex flex-wrap my-5">
      ...
      <div className="col-md-5 my-5  store">
        <h1>{props.h1}</h1>
        <h6>{props.h6} </h6>
    ...
    <div className={props.className}>
      <div className="card ins">
        ...
        <div className="card-body">
          ...
          <p className="card-text prom">{props.p1}</p>
...
export function Frequently(props: any) {
  return (
    <div>
      <button
        className=" fw-bold button-collapse text-start col-12 p-3"
        type="button"
        data-bs-toggle="collapse"
      ...
      <div>
        <div className="collapse collapse-horizontal" id="collapseWidthExample">
          <div className="card card-body">{props.cardbody}</div>
        </div>
      </div>
    </div>
  );
    ...
    <div className="footer py-5 px-3">
      <div className="row">
        <div className="col-md-3">
          <img
            className="img-fluid col-3 mb-3"
            src={
              "https://www.paype.co.in/static/media/Paype%20circle.d66c49586b04e5d30bff.png"
            }
            alt="."
          />
          <p className="my-3">
            PayPe Pvt. Ltd. was founded in 2022 with the aim of transcending the
            gap between physical and digital payments, thus enabling users to
            perform digital financial transactions using cash.
          </p>
        </div>
